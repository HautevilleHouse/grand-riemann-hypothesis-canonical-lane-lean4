/-!
# grand-riemann-hypothesis-canonical-lane Lean migration boundary
...
`GrandRiemannHypothesisCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "grand-riemann-hypothesis-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/grand-riemann-hypothesis-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for the Grand Riemann Hypothesis: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["analytic-number-theory", "l-functions", "mathematical-proof", "reproducibility", "artin-l-functions", "automorphic-forms", "grand-riemann-hypothesis", "canonical-lane", "local-to-global", "manifold-constrained"]
